...
class EntryDefinition:
    ...
    def resolve_stage(self, skip_checks: bool = False) -> DictStr:
        ...
        outs = self.context.resolve(self.definition.get('outs', []))
        ...
        deps = self.context.resolve(self.definition.get('deps', []))
        with self.context.set_temporarily(dict(deps=deps, outs=outs)):
